...
> 文档信息：2026-09-08 起草 v1.0；2026-09-08 独立调研与实现对拍后升 v1.1；状态 = **G1 审查退回修订，待复审**。**动工硬前提 = AM5 G2（M5-22）签署 + 本文 P0 项闭环**（拆解 §9 依赖链：M6-01 ← M5-22；拆解 §"禁止并行"条款：前一里程碑 G2 未过不得启动依赖其真值/契约的下一里程碑）。
