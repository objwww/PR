...
# 1) 置换
NEWHASH=$(/opt/jdk-21.0.12.1+1/bin/java -cp /tmp/ssc.jar /tmp/Gen.java 'Tmp#v2verify-20260916')
BK=/tmp/env-backup-v2verify-$(date +%Y%m%dT%H%M%S)
